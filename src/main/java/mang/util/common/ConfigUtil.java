...
public class ConfigUtil {
	...
	public static String getConfigPathFromDefault(String filePath, String defaultPath) {
		return getConfigPathFromDefault(filePath, defaultPath, true);
	}
	 ...
	 * @return String 路径
	 */
	public static String getConfigPathFromDefault(String filePath, String defaultPath, boolean isOutputLog) {
